...
describe('map tests', () => {
  ...
  it.skip('should return an array with the last constter of each string', () => {
  ...
  it.skip('should transform a large object into an array of objects', () => {
    const largeObject = {key1: {name: 'jhun', location: 'CA'}, key2: {name: 'brenna', location: 'MN'}, key3:{name: 'louisa', location: 'CO'}}
